...
$sql = "select *from `tbl_order`,`tbl_user` where `tbl_order`.`user_id`=`tbl_user`.`user_id` and `status`=3";
                            ...
                            foreach ($list_order as $item) {
                                ...
                                <tr>
                                    ...
                                    <td><a
                                        ...
                                        | <a
                                            href="?mod=order&act=delete&user_id=<?php echo $user_id ?>&code_order=<?php echo $item['code_order'] ?>">Xóa</a>
                                    </td>
                                </tr>
                                <?php
                            }
