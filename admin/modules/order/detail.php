    ...
    <div class="container">
        ...
        <div class="row mt-4 mb-4">
            <div class="col-md-5">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Thanh toán :
                        <?php if ($order['payment'] == 3) {
                            echo "Đã thanh toán qua ví MOMO";
                        } ?>
                    </label>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($list_order_detail as $item) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo format_number($item['price_buy']) ?>
                                </td>
                                <td>
                                    <?php echo $item['quantity_buy'] ?>
                                </td>
                                <td>
                                    <?php echo format_number($item['price_buy'] * $item['quantity_buy']) ?>
                                </td>
