...
$sql = "select *from `tbl_order`,`tbl_user` where `tbl_order`.`user_id`=`tbl_user`.`user_id` and `status`=1";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        foreach ($list_order_detail as $detail) {
                                            $sum += $detail['pro_price'] * $detail['quantity_buy'];
                                        }
                                        echo $sum;
                                        ?>
                                    </td>
                                    ...
                                    <td><a
                                        ...
                                        | <a
                                            href="?mod=order&act=check&user_id=<?php echo $user_id ?>&id_order=<?php echo $item['id_order'] ?>">Xác nhận</a>
                                    </td>
                                </tr>
                                <?php
                            }
