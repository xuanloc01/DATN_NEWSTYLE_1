            ...
            <div class="col-md-4 mt-4 mb-4">
                <form method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" class="form-control" id="" cols="30" rows="3"><?php echo $user['address'] ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <a class="btn btn-primary w-100" href="?mod=acount&act=change_pass&user_id=<?php echo $user_id ?>">Đổi mật khẩu</a>
                </form>
            </div>
            <div class="col-md-4"></div>
        </div>
